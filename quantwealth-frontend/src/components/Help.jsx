...
const FAQS = [
  { q: 'What does the Strategy Simulator do?', a: 'It backtests your chosen strategy (Momentum, Mean Reversion, Breakout, or Donchian) on up to 10 years of historical data so you can evaluate performance before risking real capital.' },
  { q: 'How are AI Signals generated?', a: 'Signals are generated using technical indicators (RSI, MACD, ATR, Donchian Channels) scanned across crypto assets. Each setup is scored and filtered for quality.' },
  ...
  { q: 'How do Price Alerts work?', a: 'Set a target price and condition (above/below) for any crypto asset. You will see a triggered status on the Watchlist page when your condition is met.' },
